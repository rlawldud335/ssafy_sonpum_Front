  ...
  <v-container>
    <div style="display: flex; justify-content: center; margin-top: 50px; margin-bottom: 50px">
      <v-img
        ...
        max-height="80"
        max-width="300"
        :src="require('@/assets/img/HOW_TO_USE_SONPUM.png')"
      ></v-img>
    </div>

    <div style="display: flex; justify-content: center; margin: 70px 0px">
      <div style="width: 40%; height: 250px; background-color: gray; border-radius: 20px"></div>
      <div
        style="
          width: 30%;
          height: 250px;
